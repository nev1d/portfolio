...
export const GithubLogo: React.FC<GithubLogoProps> = ({ animation, className }) => {
    const { runCycle, pathProps } = useSvgAnimation({ animation });
    ...
    return (
        <svg
            ...
            fill='none'
            className={clsx(cn.github, className)}
            strokeWidth={0.2}
        >
            <motion.path
                {...pathProps}
