...
const Face = (props: JSX.IntrinsicElements['group']) => {
    ...
    return (
        ...
        >
            ...
            <group position={[0.255, 0.532, 0.46]} rotation={[1.493, 0.002, 0.006]} scale={0.07}>
                <mesh geometry={nodes.brooch.geometry} material={nodes.brooch.material} />
                <mesh geometry={nodes['brooch-back'].geometry} material={nodes['brooch-back'].material} />
                <mesh geometry={nodes.stitch.geometry} material={nodes.stitch.material} />
                <mesh geometry={nodes.visor.geometry} material={nodes.visor.material} />
            ...
            <mesh geometry={nodes.FBHead.geometry} material={nodes.FBHead.material} position={[0.277, 0.071, -0.075]} />
            <mesh
